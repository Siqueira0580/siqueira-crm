...
export default function RedefinirSenhaPage() {
  ...
  useEffect(() => {
    // Supabase puts the access_token in the URL hash after the email link is clicked.
    // The @supabase/ssr client automatically exchanges it for a session.
    // We listen for the SIGNED_IN / PASSWORD_RECOVERY event to confirm the session is ready.
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-300 text-sm mt-1">Redefinição de senha</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          {status === 'success' ? (
            <div className="text-center">
              ...
              <h2 className="text-lg font-semibold text-slate-800">Senha atualizada!</h2>
            ...
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-800">Nova senha</h2>
