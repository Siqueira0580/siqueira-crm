...
export default function GlobalSearch() {
  ...
  return (
    <div ref={containerRef} className="relative w-28 sm:w-72">
      {/* Input */}
      ...
      {/* Dropdown — largura própria (não amarrada ao input estreito do mobile) */}
      {open && (query.length >= 2) && (
        <div className="absolute top-full right-0 mt-2 w-72 max-w-[85vw] rounded-xl border border-slate-200 dark:border-slate-700
